...
- **"arxiv", "arxiv ID", "arxiv preprint", "physics preprint", "physics preprints", "computer science preprint", "math preprint", "latest ML papers", "latest AI papers"** → `/arxiv-search`
